...
export default function Projects() {
  ...
  return (
    <Element name="projects">
      <div>
        <p className="text-center text-accent text-3xl font-bold">
          My Projects
        </p>
        <p className="text-white text-center mt-2">
          Welcome to my project showcase! Here, you'll find a collection of web
          applications and creative solutions <br /> I've built using
          technologies like React, Tailwind CSS, and JavaScript. Each project
          <br /> reflects my journey in web development, focusing on clean
        ...
        <div className="mt-16">
          ...
          <div>
            ...
            <p className="text-[#E5E7EB] mt-2 lg:w-[50%] md:w-[70%] w-full">
              ...
              long-term use. Whether you need a compact car for a quick city
              trip or a luxury vehicle for a special occasion.
            </p>
            ...
            <div className="lg:w-[35%] md:w-[35%] flex flex-col md:flex-row lg:flex-row gap-2 mt-2">
              <button
                onClick={() =>
                  handleOpenBlank("https://car-rent-195e4.web.app/")
                }
